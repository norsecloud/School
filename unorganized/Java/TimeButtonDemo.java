...
public class TimeButtonDemo extends Application 
{
  ...
  protected BorderPane getPane() 
  {
    ...
    Image imageUS = new Image("file:usa.jpg");
    ...
    Image imageEU = new Image("file:eu.jpg");
    ImageView imageV01 = new ImageView(imageEU);
    imageV01.setFitWidth(40);
    imageV01.setFitHeight(40);
    btn24Hr.setGraphic(imageV01);
    
    //construct clock class
    ...
    paneForButtons.setAlignment(Pos.CENTER);	//center align the buttons
    //add button pane to main pane at bottom
